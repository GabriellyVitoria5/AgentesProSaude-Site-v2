        ...
        <aside>
            <article class="alinharCard">
                ...
                ?>
                    ...
                    <p>Nome:</p> <input class="informaçoes" readonly type="text" name="txtNome" value="<?php echo $exibir["nome_agente"] ?>"> 
                    <p>Telefone:</p> <input class="informaçoes" readonly type="text" name="txtTel" value="<?php echo $exibir["telefone"] ?>"> 
                    <p>Email:</p> <input class="informaçoes" readonly type="text" name="txtEmail" value="<?php echo $exibir["email"] ?>"> 
                    <p>CPF:</p> <input class="informaçoes" readonly type="text" name="txtCpf" value="<?php echo $exibir["cpf_agente"] ?>"> 
